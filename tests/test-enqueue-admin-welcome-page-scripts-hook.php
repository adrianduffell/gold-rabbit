...
use function AuthenticImages\license_enqueue_init;
...
class Test_Enqueue_Admin_Welcome_Page_Scripts_Hook extends WP_UnitTestCase {
	...
	public function test_localizes_the_environment_type(): void {
		// Arrange.
		set_current_screen( 'toplevel_page_authenticimages-welcome' );
		...
		$data = wp_scripts()->get_data( 'authenticimages-welcome-page', 'data' );
